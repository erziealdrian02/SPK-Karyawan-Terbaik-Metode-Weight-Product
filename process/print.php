        ...
        <table class="table" style="margin-right=30px">
            <thead>
                <tr class="bg-light">
                    ...
                    <th class="border-top-0" rowspan="2">Nama Karyawan</th>
                    <th class="border-top-0" rowspan="2">Jabatan</th>
                    <th class="border-top-0" colspan="10">Kriteria Penilaian</th>
                    <th class="border-top-0" rowspan="2">Total</th>
                    <th class="border-top-0" rowspan="2">Total Vector</th>
                </tr>
                <tr class="bg-light">
                    <th class="border-top-0">Kejujuran</th>
                    <th class="border-top-0">Kualitas</th>
                    <th class="border-top-0">Kuantitas</th>
                    <th class="border-top-0">Inisiatif</th>
                    <th class="border-top-0">Loyalitas</th>
                    <th class="border-top-0">Kerja Sama</th>
                    <th class="border-top-0">Ketelitian</th>
                    <th class="border-top-0">Merasa Memiliki</th>
                    <th class="border-top-0">Tanggung Jawab</th>
                    <th class="border-top-0">Kerajinan</th>
                </tr>
            </thead>
            <tbody>
';
    ...
    while ($data_bobot = mysqli_fetch_array($select)) {
        ...
        $html .= '
            <tr class="table-data">
                ...
                <td>' . $data_absen['ly'] . '</td>
                <td>' . $data_absen['ks'] . '</td>
                <td>' . $data_absen['kte'] . '</td>
                <td>' . $data_absen['mm'] . '</td>
                <td>' . $data_absen['tj'] . '</td>
                <td>' . $data_absen['kjin'] . '</td>
                <td>' . round($vector, 4) . '</td>
                <td>' . round($vector_v, 4) . '</td>
            </tr>
        ';
    }
}
...
<div class="signature">
        <p>Bogor, ' . $formattedDate . '</p>
        <p style="margin-top: 80px;">_________________________</p>
        <p style="margin-top: 10px;">Bino Hermansyah (HRD Manager)</p>
</div>
