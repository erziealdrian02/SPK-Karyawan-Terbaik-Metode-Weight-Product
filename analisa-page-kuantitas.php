      ...
      <div class="container-fluid">
         ...
         <div class="card mb-3">
            <div class="card-header">
               <a href="./process/print-kuantitas.php" target="_blank" class="btn btn-success text-white" role="button" aria-disabled="true">Print</a>
            </div>
            <div class="card-body">
                  ...
                  <div class="table-responsive">
                     <table class="table table-bordered text-center b" id="dataTable" width="100%" cellspacing="0">
                        ...
                        <tbody>
                           <?php
                           $no = 1;
                           $sql = mysqli_query($connect, "SELECT * FROM perhitungan_absen ORDER BY kt DESC");
                           if (!$sql) {
                              die('Query Error: ' . mysqli_error($connect));
                           }
